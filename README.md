...
We recommend setting the following configuration. These options are not set by default as to conform to the expectations of backwards-compatible behavior.
